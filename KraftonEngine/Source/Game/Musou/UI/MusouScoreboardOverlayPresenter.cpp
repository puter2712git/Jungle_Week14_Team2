		...
		return
			"<div id=\"scoreboard-overlay\">"
				"<div id=\"scoreboard-panel\">"
					...
					"<div id=\"victory-menu\">"
						"<div id=\"victory-restart-button\" class=\"pause-button scoreboard-action-button\">재도전</div>"
						"<div id=\"victory-stop-button\" class=\"pause-button scoreboard-action-button\">나가기</div>"
					"</div>"
				"</div>"
			"</div>";
	}
