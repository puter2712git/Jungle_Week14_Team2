			...
			"<div id=\"scoreboard-overlay\">"
				"<div id=\"scoreboard-panel\">"
					...
					"<div id=\"scoreboard-input-row\">"
						...
						"<div id=\"scoreboard-save-button\">"
							"<img class=\"scoreboard-save-button-frame scoreboard-save-button-frame-normal\" src=\"btn_normal.png\" />"
							"<img class=\"scoreboard-save-button-frame scoreboard-save-button-frame-hover\" src=\"btn_hover.png\" />"
							"<div class=\"scoreboard-save-button-label\">저장</div>"
						"</div>"
					"</div>"
