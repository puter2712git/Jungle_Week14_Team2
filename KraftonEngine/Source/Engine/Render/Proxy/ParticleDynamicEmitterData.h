...
struct FDynamicTrailEmitterData : public FDynamicSpriteEmitterDataBase
{
	FDynamicTrailEmitterData(int32 InEmitterIndex, const FDynamicEmitterReplayDataBase& InSource);
